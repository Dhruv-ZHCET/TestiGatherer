        ...
        <div className='w-full flex flex-col justify-center text-white font-bold bg-[#151719]'>
            ...
            <div className='flex justify-between py-8 items-center border-gray-500 border-2 border-x-0 border-t-0'>
                <div className='flex gap-4 ml-4'>
                    <img className='w-24 rounded-md' src={spaceinfo.spaceinfo.logo || "https://via.placeholder.com/150"} alt='' />
                    <div>
                        <h1 className='text-white font-bold text-4xl'>{spaceinfo.spaceinfo.space_name}</h1>
                        <p className='text-gray-400 font-semibold'>
                            Space public URL : <a href={`http://localhost:5173/testimonial.to/${spaceinfo.spaceinfo.space_name}`}>
                                http://localhost:5173/testimonial.to/{spaceinfo.spaceinfo.space_name}
                            </a>
                        </p>
                    </div>
                </div>
            ...
            <div className='px-4 pb-6 flex'>
                ...
                <div className='w-4/5 flex flex-col gap-10 pt-16 items-center px-32'>
                    ...
                    {testimonials.length ? testimonials.map((testimonial, index) => (
                        <div key={index} className='bg-[#2f3136] w-[90%] flex flex-col justify-center px-6 pt-4 pb-10 gap-3 rounded-md'>
                            ...
                            {testimonial.imageURL && <img className='w-[25%] h-2/4 rounded-md' src={testimonial.imageURL} alt='' />}
                                    ...
                                    <div>
                                        ...
                                        <div className='flex flex-row gap-2 items-center'>
                                            <img
                                                ...
                                                alt=''
                                            />
                                            <span className='text-base font-normal'>{testimonial.username}</span>
                                        </div>
                                    </div>
