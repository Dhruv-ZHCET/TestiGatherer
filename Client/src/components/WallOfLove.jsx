...
const WallOfLoveCustomization = ({ selectedLayout, onClose, showContent }) => {
	...
	return (
		<div className='bg-white rounded-lg min-w-[1200px] max-h-[90vh] overflow-y-auto text-gray-800'>
			{/* Header */}
...
const WallOfLove = ({ isOpen, onClose }) => {
	...
	return (
		<div className='fixed inset-0 bg-black/70 flex items-center justify-center z-50'>
			{!showCustomization ? (
				<div className='w-full max-w-6xl bg-white rounded-2xl shadow-lg px-4 flex flex-col gap-2'>
					{/* Header */}
